...
const handleSubmitGitLab = (e) =>{
  fetch(`https://gitlab.com/users/${userInput}` ) 
  .then(res => res.json())
  .then(data =>{
    if(data.message) {
...
//// HANDLE SUBMIT ///
  return (
    <div>
      <div className='navbar'> <h1> Buscador de usuarios de GITLAB</h1></div>
    <div className='search'>  
     <Form onSubmit={handleSubmitGitLab}>
          <Form.Group>
            <input  
